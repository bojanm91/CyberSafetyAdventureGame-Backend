...
exports.BADGES_DATA = exports.QUESTS_DATA = exports.DISCIPLINES_DATA = void 0;
...
exports.QUESTS_DATA = [
    {
        ...
        orderInDiscipline: 1,
        scenario: "Korisnik kreira nalog za novi online servis koji čuva važne finansijske dokumente. Servis traži da postavi sigurnu lozinku. U ponudi je pet opcija lozinki.",
        taskText: "Izaberi najbezbjedniju lozinku.",
        hintText: "Dužina lozinke je često važnija od nasumičnog dodavanja jednog simbola.",
        feedbackCorrect: "Dobra lozinka treba da bude duga, jedinstvena i teško pogodiva. Fraze koje kombinuju više nepovezanih riječi sa brojevima i simbolima su gotovo nemoguće za pogoditi, čak i pri brutalnom napadu. Izbjegavaj imena, gradove, godine i česte šablone poput 'P@ssword!'.",
    ...
    },
    {
        ...
        questType: "multiple_choice",
        orderInDiscipline: 2,
        scenario: "Aplikacija za email nudi korisničku opciju uključivanja dvofaktorske autentifikacije (2FA) kako bi dodatno zaštitio nalog. Korisnik razmišlja šta je pametno uraditi.",
        taskText: "Koji izbor je najbezbjedniji za zaštitu naloga?",
        hintText: "Ako neko sazna lozinku, šta ga još može zaustaviti?",
        feedbackCorrect: "Dvofaktorska autentifikacija dodaje drugi sloj zaštite. Čak i ako napadač nekako dođe do lozinke, bez fizičkog pristupa tvom uređaju ne može pristupiti nalogu. Autentifikator aplikacije (poput Google ili Microsoft Authenticator) su sigurnije od SMS kodova.",
        miniConclusion: "2FA je jedna od najvažnijih mjera zaštite - uvijek je uključi gdje god je dostupna.",
        options: [
    ...
    },
    {
        ...
        questType: "decision",
        orderInDiscipline: 1,
        scenario: "Korisniku stiže email od adrese 'support@bankovni-sistem-secure.net' sa naslovom 'HITNO: Vaš nalog je privremeno suspendovan'. Tekst glasi: 'Poštovani korisniče, zbog sigurnosne provjere Vaš nalog će biti blokiran za 2 sata. Kliknite ovdje i unesite podatke kartice kako biste potvrdili identitet.'",
        ...
        feedbackCorrect: "Phishing poruke gotovo uvijek koriste pritisak i hitnost kako bi korisnik reagovao brzo bez razmišljanja. Legitimna banka nikad ne traži da unosiš podatke kartice preko linka iz emaila. Pravi email banke dolazi sa zvaničnog domena, nikad sa domena poput 'bankovni-sistem-secure.net'.",
        miniConclusion: "Sumnjivim emailovima nikad ne klikaj na linkove - idi direktno na zvanični sajt upisivanjem adrese u browser.",
        options: [
    ...
    },
    {
        ...
        orderInDiscipline: 2,
        scenario: "Korisnik klikne na link iz emaila i otvori se stranica koja izgleda identično kao PayPal. URL u browseru je 'paypaI-security-login.com' (slovo l je zamijenjeno velikim I). Stranica traži da uneseš email, lozinku i broj kreditne kartice 'radi verifikacije'.",
        taskText: "Koji elementi na ovoj stranici su jasni znakovi prevare?",
        hintText: "Ne gledaj samo logo i dizajn. Provjeri URL adresu i vrstu podataka koji se traže.",
        feedbackCorrect: "Napadači često kopiraju izgled poznatih servisa do savršenstva. Prava provjera uvijek počinje od URL adrese - 'paypaI-security-login.com' nije PayPal. Osim toga, PayPal nikad ne traži broj kartice na login stranici. Hitan ton je još jedan upozoravajući znak.",
        miniConclusion: "Uvijek provjeri URL - jedan zamijenjeni karakter može biti gotovo nevidljiv. I legitimni servisi nikad ne traže sve podatke odjednom.",
        options: [
    ...
    },
    {
        ...
        questType: "spot_danger",
        orderInDiscipline: 3,
        scenario: "U restoranu korisnik primjećuje QR kod zalijepljen fizički preko originalnog QR koda na meniju. Skenira ga i otvara se stranica koja traži Google login 'kako bi se pregledao meni i rezervisao sto'.",
        ...
        feedbackCorrect: "QR phishing je sve češći i veoma efikasan jer su ljudi navikli da skeniraju QR kodove bez razmišljanja. Fizički nalijepljen kod je već sumnjiv. Meni restorana ne zahtijeva Google login - to je jasan znak da je cilj krađa naloga. Skraćeni ili nepoznati URL je treći alarm.",
        miniConclusion: "QR kod = link. Uvijek provjeri kuda vodi i da li je zahtjev logičan u datom kontekstu.",
        options: [
    ...
    },
    {
        ...
        orderInDiscipline: 1,
        scenario: "Korisnik se sprema za putovanje i želi da objavi fotografiju avionske karte na Instagram story kako bi podijelio uzbuđenje sa pratiocima.",
        ...
        feedbackCorrect: "Avionska karta sadrži ime i prezime, broj leta, sjedište, kod rezervacije i bar kod koji može otkriti broj Frequent Flyer programa. Kod rezervacije može biti iskorišćen da neko pristupi tvojoj rezervaciji, promijeni sjedište ili čak otkaže let. Story traje 24 sata ali može biti screenshotovan u sekundi.",
        miniConclusion: "Osjetljive podatke zamaži ili sakrij prije objave - vrijedi za karte, račune, dokumente i sve što ima jedinstvene kodove.",
        options: [
    ...
    },
    {
        ...
        questType: "decision",
        orderInDiscipline: 2,
        scenario: "Korisnik sjedi u kafiću i hitno treba da provjeri stanje na bankovnom računu i napravi uplatu. Vidi otvorenu Wi-Fi mrežu pod imenom 'Kafic_Free_WiFi' bez lozinke.",
        ...
        miniConclusion: "Javni Wi-Fi nije za internet bankarstvo i osjetljive naloge - koristi mobilne podatke ili VPN.",
        options: [
    ...
    },
    {
        ...
        questType: "risk_assessment",
        orderInDiscipline: 3,
        scenario: "Korisnik preuzima besplatnu aplikaciju za baterijsku lampu sa Play Store-a. Tokom instalacije, aplikacija traži sljedeće dozvole: pristup kontaktima, stalna lokacija, mikrofon i čitanje SMS poruka.",
        ...
        feedbackCorrect: "Aplikacija za baterijsku lampu treba pristup samo kameri/flešu uređaja. Zahtjev za kontakte, lokaciju, mikrofon i SMS poruke nema nikakvo opravdanje za lampicu - ovo su dozvole koje koriste špijunske aplikacije (spyware) za prikupljanje podataka o korisniku. Visok rizik, ne instalirati.",
        miniConclusion: "Uvijek provjeri da li dozvole odgovaraju funkciji aplikacije. Daj aplikacijama samo minimalan neophodan pristup.",
        options: [
    ...
    },
    {
        ...
        questType: "multiple_choice",
        orderInDiscipline: 4,
        scenario: "Korisnik treba da podijeli seminarski rad sa profesorom putem Google Drive linka. Profesor je dao svoju email adresu i traži da pošalješ link.",
        ...
        feedbackCorrect: "Princip najmanjih privilegija znači da korisniku daješ samo pristup koji mu je stvarno potreban. Profesor treba da pročita rad - dakle view dozvola je dovoljna. Dijeljenje sa specifičnom email adresom sprječava slučajan pristup bilo ko ima link, a professor ionako nema razloga da uređuje tvoj rad.",
        miniConclusion: "Uvijek dijeli sa specifičnom adresom i samo sa dozvolom gledanja - osim ako neko stvarno treba da uređuje.",
        options: [
    ...
    },
    {
        ...
        questType: "decision",
        orderInDiscipline: 1,
        scenario: "Korisnik dobija email od adrese 'delivery@courier-fast-rs.net' sa prilogom 'Faktura_2026.exe'. Email kaže: 'Poštovani, vaš paket je spreman za preuzimanje. Preuzmite fakturu klikom na prilog za detalje dostave.'",
        taskText: "Šta treba uraditi sa ovim emailom i prilogom?",
        hintText: "Obrati pažnju na ekstenziju fajla. Šta rade .exe fajlovi?",
        feedbackCorrect: "Izvršni fajlovi (.exe) mogu pokrenuti bilo koji kod na računaru. Faktura nikad ne bi trebalo da bude .exe - to bi trebalo biti .pdf ili .docx. Nepoznati pošiljalac, sumnjiva domena i .exe ekstenzija su tri jasna alarma. Čak i ako skeniraš antivirusom, najsigurnija opcija je ignorisati i obrisati ovakav email.",
    ...
    },
    {
        ...
        questType: "decision",
        orderInDiscipline: 2,
        scenario: "Korisnik uključuje računar i vidi poruku koja pokriva cijeli ekran: 'Vaši fajlovi su šifrovani! Platite 500€ u Bitcoin-u na adresu XXX u roku od 48 sati ili zauvijek gubite sve dokumente, slike i podatke.'",
        ...
        miniConclusion: "Kod ransomwarea: izoluj uređaj odmah, ne plaćaj, provjeri backup, traži stručnu pomoć.",
        options: [
    ...
    },
    {
        ...
        questType: "decision",
        orderInDiscipline: 1,
        scenario: "Korisnik dobija Instagram poruku od profila prijatelja koji kaže: 'Hej, ovdje sam vani bez novca, ukraden mi je novčanik. Možeš li mi hitno poslati 50€ na ovaj PayPal? Sutra ću ti vratiti, obećavam.' Profil izgleda kao prijateljev pravi nalog.",
